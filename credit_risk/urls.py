...
urlpatterns = [
    ...
    path('poll/', views.assessment_status_batch, name='assessment_status_batch'),
    path('new/', views.assessment_create, name='assessment_create'),
    path('<int:pk>/', views.assessment_detail, name='assessment_detail'),
    path('<int:pk>/status/', views.assessment_status_json, name='assessment_status_json'),
    path('<int:pk>/ask/', views.assessment_ask, name='assessment_ask'),

...
class CreditAssessmentAdmin(admin.ModelAdmin):
    list_display = ('customer', 'status', 'score', 'risk_level', 'recommendation', 'requested_by', 'created_at')
    ...
    readonly_fields = (
        ...
        'status', 'error_message', 'score', 'risk_level', 'recommendation', 'summary', 'factors',
